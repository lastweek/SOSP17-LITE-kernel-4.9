...
int __client_send_message_sge_UD(ltc *ctx, int target_node, int type, void *addr, int size, uint64_t store_addr, uint64_t store_semaphore, int priority, const char *func, int line);

#define client_send_message_sge_UD(a,b,c,d,e,f,g,h)	\
	__client_send_message_sge_UD(a,b,c,d,e,f,g,h,__func__,__LINE__)
